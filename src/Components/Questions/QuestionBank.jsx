          ...
          <div className="p-6">
            ...
            {activeTab === 'home' && (
              <div className="flex flex-col gap-4 lg:flex-row mb-10">
                ...
                <div className="bg-gradient-to-r mx-12 px-10 h-64 mt-20 from-green-400 via-blue-500 to-purple-500 animate-gradient text-center p-4 rounded-lg shadow-lg mb-6 md:mb-0 md:mr-4">
