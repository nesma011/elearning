        ...
        <main className="flex-1">
          ...
          <div className="p-6">
            ...
            <div className="flex space-x-4 mb-6">
              ...
              <h1 className='text-4xl font-semibold ps-20'>Ramadan Kareem 🌙🌙</h1>
            </div>
            ...
            {activeTab === 'home' && (
              <div className="flex flex-col gap-4 lg:flex-row mb-10">
                ...
                <div className="bg-gradient-to-r mx-12 px-10 h-64 mt-32 from-green-400 via-blue-500 to-purple-500 animate-gradient text-center p-4 rounded-lg shadow-lg mb-6 md:mb-0 md:mr-4">
